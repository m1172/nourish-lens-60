...
export default function BottomNav() {
  const linkClass = "flex flex-col items-center justify-center py-2 text-muted-foreground transition-colors";
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border safe-area-bottom z-50">
      <div className="max-w-screen-sm mx-auto flex items-center justify-around h-16 px-4">
        ...
        <NavLink to="/recipes" className={linkClass} activeClassName={activeClass}>
        ...
        <NavLink to="/progress" className={linkClass} activeClassName={activeClass}>
