...
import { ChevronLeft, ChevronRight, Plus, Settings, Flame, Wheat, Drumstick, Droplet, Footprints, CheckCircle2 } from 'lucide-react';
...
export default function Diary() {
  ...
  const caloriesLeft = (profile?.daily_calorie_goal || 2000) - dailyStats.calories;
    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="max-w-screen-sm mx-auto">
        ...
        <div className="flex items-center justify-between p-4 bg-card border-b border-border">
          ...
          <h1 className="text-lg font-semibold">{format(currentDate, 'dd MMMM')}</h1>
        ...
        <div className="p-6">
            ...
            <div className="relative w-48 h-48 mx-4">
              <svg className="w-full h-full -rotate-90">
                ...
                <circle
                  ...
                  strokeWidth="12"
                  strokeDasharray={`${(dailyStats.calories / (profile?.daily_calorie_goal || 2000)) * 553} 553`}
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="text-center">
              ...
              <div className="text-lg font-bold">{Math.round(dailyStats.carbs)} / {profile?.daily_carbs_goal || 175}</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <div className="text-lg font-bold">{Math.round(dailyStats.protein)} / {profile?.daily_protein_goal || 131}</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <div className="text-lg font-bold">{Math.round(dailyStats.fats)} / {profile?.daily_fats_goal || 58}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Card className="p-4 bg-success/10">
              <div className="flex items-center justify-between mb-2">
                ...
                {stepsProgress >= 100 && <CheckCircle2 className="h-5 w-5 text-success" />}
              </div>
              <div className="text-lg font-bold">{dailyStats.steps.toLocaleString()} / {stepsGoal.toLocaleString()}</div>
            </Card>
            ...
            <Card className="p-4 bg-water/10">
              ...
              <div className="text-lg font-bold">{dailyStats.water} / {waterGoal}</div>
            </Card>
          </div>
        </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <span className="flex items-center gap-1">
                          ...
                          {meal.meal_items?.reduce((sum: number, item: any) => sum + (item.calories || 0), 0)} kcal
                        </span>
                      </div>
                    </div>
                  </div>
