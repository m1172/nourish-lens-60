      ...
      const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'Extract food items from user speech. Return JSON array with: [{name, quantity, unit, estimated_calories}]. Be reasonable with calorie estimates.'
            },
            {
              role: 'user',
              content: text
        ...
        <Card className="p-6">
          <div className="text-center space-y-4">
            ...
            <Button
              ...
              className="w-full"
            >
              {isListening ? 'Listening...' : processing ? 'Processing...' : 'Start Recording'}
            </Button>
          </div>
        </Card>
